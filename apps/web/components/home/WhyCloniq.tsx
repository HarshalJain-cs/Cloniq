...
const audiences = [
  ...
  },
  {
    Icon: Terminal,
    who: "Developers",
    example: "Build on top via our OpenAPI spec or MCP server. Cloniq as infrastructure for your next product.",
...
export default function WhyCloniq() {
  return (
